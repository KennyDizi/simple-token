...
contract PeterShareTokenSale is PeterShareTokenSaleConfig, Ownable, Pausable, Salvageable {
    ...
    constructor(uint[] _batchStartTimes, uint _endTime, uint _usdPerMEth, uint _presaleWei,
